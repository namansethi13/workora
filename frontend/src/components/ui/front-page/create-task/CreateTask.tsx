...
function CreateTask() {
  return (
    <div className="w-[90%] max-w-[553px] h-[240px] sm:h-[295px] bg-[var(--custom-blue)]/74 dark:bg-[var(--custom-light-blue)] rounded-[52px] sm:rounded-[52px] flex flex-col justify-center items-center px-4">
      {/* Plus Button */}
